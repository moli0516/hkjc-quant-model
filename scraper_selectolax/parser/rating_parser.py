...
def data_process() -> Optional[List[Dict[str, Any]]]:
    url = "https://racing.hkjc.com/racing/info/mcs/Chinese/Horses/clas/?&rf=http://racing.hkjc.com/zh-hk/local/information/latestonhorse?View=Horses/clas/&pageid=racing/local"
    hook = Hook(url)
    
    result = hook.get_no_params_tree()
    if not result:
