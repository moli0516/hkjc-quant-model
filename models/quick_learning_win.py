...
latest_features = [
    # ================== 1. 位置率相關特徵 (代表穩定性與底盤) ==================
    "j_smoothed_place_rate", "t_smoothed_place_rate", "jt_smoothed_place_rate", "h_smoothed_place_rate",
    ...
    # ================== 2. 新增：獨贏率相關特徵 (代表爆發力與奪冠能力) ==================
    # 建議在大 DF 數據清洗時，也算出這套歷史 Win Rate 丟進來
    "j_smoothed_win_rate", "t_smoothed_win_rate", "jt_smoothed_win_rate", "h_smoothed_win_rate",
    "j_smoothed_rolling_30_win_rate", "h_smoothed_rolling_5_win_rate",
    "h_track_smoothed_win_rate", "h_env_smoothed_win_rate",
    
    # ================== 3. 速度與物理特徵 (硬指標) ==================
    "h_mean_speed_z", "h_rolling_2_speed_z_std", "h_rolling_2_mean_speed_z"
]

# 物理特徵與靜態特徵
PHYSICAL_FEATURES = ["draw", "weight", "rank_weight"]
